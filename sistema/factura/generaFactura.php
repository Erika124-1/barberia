<?php
	...
	if(empty($_REQUEST['cl']) || empty($_REQUEST['f']))
	{
		...
		$pdf->Cell(60, 5, utf8_decode("Diamante´s Barbería"), 0, 1, 'C');
		$pdf->SetFont('Arial', '', 9);
		$pdf->Cell(80, 5, utf8_decode("Barrio Santa Inés"), 0, 1, 'C');
		$pdf->Cell(80, 5, utf8_decode("Cr.1 #34-35 Local 1"), 0, 1, 'C');
		...
		$pdf->SetFont('Arial', 'B', 7.5);
		$pdf->Cell(75, 5, "Detalles del Servicio", 0, 1, 'L');
