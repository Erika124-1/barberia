<?php include_once "includes/header.php"; ?>
    ...
    <h1 class="h1 mb-4 text-center font-weight-bold text-dark">Nueva Venta</h1>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                               
                                <a href="#" class="btn btn-light btn_new_cliente" style="background-color: #ADD8E6; color: #000;"><i class="fas fa-user-plus mr-2"></i> Nuevo Cliente</a>
                            </div>
                                    ...
                                    <form method="post" name="form_new_cliente_venta" id="form_new_cliente_venta">
                                        ...
                                        <div class="row">
                                            ...
                                            <div id="div_registro_cliente" style="display: none;">
                                                <button type="submit" class="btn btn-light" style="background-color: #ADD8E6; color: #000;">Guardar</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                            ...
                            <div class="row">
                                <!-- <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <p style="font-size: 16px; text-transform: uppercase; color: blue;">echo $_SESSION['user']; ?></p>
                                    </div>
                                </div> -->
                                <div class="col-lg-6">
                                    
                                    <div id="acciones_venta" class="form-group">
                                        <a href="#" class="btn btn-danger" id="btn_anular_venta"><i class="fas fa-ban"></i>Anular</a>
                                        <a href="#" class="btn btn-primary" id="btn_facturar_venta"><i class="fas fa-file-invoice"></i> Generar Factura</a>
                                    </div>
                                </div>
                            </div>
